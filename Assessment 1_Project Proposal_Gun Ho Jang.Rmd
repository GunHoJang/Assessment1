...
<<<<<<< HEAD
# Creating the scatter plot for Affordability of a Healthy Diet by Country
ggplot(food_affordability_data, aes(x = Country, y = `Affordability of a healthy diet: ratio of cost to food expenditures`)) +
  geom_point() +
  labs(
    title = "Affordability of a Healthy Diet by Country",
    x = "Country",
=======
...
- In Africa, the highest ratio is 318% for the nation of Burundi, and for Asia, the sole outlier represents Syria at 301%. Both nations are classified by a past or present history of volatility and conflict, and struggle considerably with poverty (<https://www.bbc.com/news/world-africa-13085064>, <https://www.bbc.com/news/world-middle-east-14703856>)
